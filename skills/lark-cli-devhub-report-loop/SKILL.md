...
With `--wiki`, each report appends a timestamped section directly into `10 Projects/<project>/60 Reports`; it does not overwrite the previous report draft or create a child report page.
